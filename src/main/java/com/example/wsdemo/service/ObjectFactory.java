 ...
 * generated in the com.example.wsdemo.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStudentResponse_QNAME = new QName("http://service.wsdemo.example.com/", "getStudentResponse");
    private final static QName _GetStudent_QNAME = new QName("http://service.wsdemo.example.com/", "getStudent");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.wsdemo.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.wsdemo.example.com/", name = "getStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.wsdemo.example.com/", name = "getStudent")
