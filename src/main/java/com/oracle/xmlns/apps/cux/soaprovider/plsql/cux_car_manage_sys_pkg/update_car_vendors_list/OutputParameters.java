...
public class OutputParameters {
    ...
    @XmlElementRef(name = "XV_ERROR_CODE", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cux_car_manage_sys_pkg/update_car_vendors_list/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> xverrorcode;
    @XmlElementRef(name = "XV_ERROR_MESSAGE", namespace = "http://xmlns.oracle.com/apps/cux/soaprovider/plsql/cux_car_manage_sys_pkg/update_car_vendors_list/", type = JAXBElement.class, required = false)
